...
.. glossary::
    ...
    exchange
        Nœud de publication dans le dialecte AMQP. Les messages publiés sur un
        *exchange* sont relayés à une ou plusieurs files d'attente sur le
        serveur, à partir desquelles les connecteurs vont consommer les
        messages.
